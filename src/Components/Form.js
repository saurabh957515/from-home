  ...
  return (
    <div>
      <div className="flex space-x-4">
        ...
        <div className=" w-1/3 bg-[#D7D7D7]">Details</div>
      </div>
      <div className="h-1.5 bg-[#274866]"></div>
      <div className="my-0-8 h-16 bg-[#E0E5EA] flex items-center ">
                ...
                <div className="col-span-full ">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="block w-full bg-[#F2F2F2] bg-[#F2F2F2] rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
